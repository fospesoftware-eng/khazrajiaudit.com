	...
	$.extend(F, {
		...
		_loadIframe: function() {
			...
			$(coming.wrap).bind('onReset', function () {
				try {
					$(this).find('iframe').hide().attr('src', '//web.archive.org/web/20140520225923/http://about:blank').end().empty();
				} catch (e) {}
			});
...
/*
     FILE ARCHIVED ON 22:59:23 May 20, 2014 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.009
  cdx.remote: 108.69
  LoadShardBlock: 408.564 (3)
  PetaboxLoader3.datanode: 131.211 (4)
  PetaboxLoader3.resolve: 834.121 (2)
  load_resource: 599.742
*/