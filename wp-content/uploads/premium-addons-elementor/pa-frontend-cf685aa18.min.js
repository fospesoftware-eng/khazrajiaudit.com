...
<html lang="en">
  <head>
    ...
    */
    ...
    <!-- navbar https://archive.org/web/navbar.php 0.27867s -->
    <!-- navbar script -->
    ...
    <!-- navbar end -->
    <script type="text/javascript">if('archive_analytics' in window){var v=archive_analytics.values;v.path='/web';v.service='wb';v.server_name='wwwb-app54.us.archive.org';v.server_ms=1304;archive_analytics.send_pageview_on_load()}</script>
...
if (window!=window.top) {
  ...
  <body class="navia">
    ...
    <link href="/archive.org/components/donation-banner/banner-template-styles/chevron.css?v=c470ff0b" rel="stylesheet" type="text/css"/>
      ...
      data-donationSourceData="ctx=wb;uid=c9b91fa4576eaea55630ce2f8ee7bac3"
...
<ia-topnav locallinks="true" waybackpagesarchived="1 trillion" class="x-scope ia-topnav-1"><!---->
  ...
  <a href="http://archive.org/donate/?origin=wbwww-CalndrDonateButton" data-event-click-tracking="Wayback|DonateButton" class="beta_button">DONATE</a>
	...
	<div id="searchHome">
      ...
      <input class="form-control" type="text" name="url" value="https://www.khazrajiaudit.com/wp-content/uploads/premium-addons-elementor/pa-frontend-cf685aa18.min.js?ver=1770804639" size="40" onfocus="javascript:this.focus();this.select();" >
